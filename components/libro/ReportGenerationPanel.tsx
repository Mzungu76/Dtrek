'use client'
// Pannello di generazione/rigenerazione del Reportage per la sua pagina di riepilogo (Fase 3, vedi
// docs/diario-a-libro-piano.md — stessa decisione di GuideGenerationPanel.tsx: pannello nuovo e
// isolato, spinner fino al completamento, nessuna anteprima live carattere-per-carattere). A
// differenza della Guida, /api/resoconto genera l'intero testo in un colpo solo (nessuna sezione
// singola) — qui replichiamo solo la chiamata di ReportReader.tsx (generateReport), non la sua UI.
