...
export default function FloraPage() {
  ...
  const gpsPoints = useMemo(() => {
    if (!activity) return []
    return activity.trackPoints.filter(p => p.lat !== undefined && p.lon !== undefined)
  }, [activity])
  ...
  }, [loadingActivity, gpsPoints, month])
  ...
  return (
    <div className="min-h-screen bg-stone-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        <button
          onClick={() => router.push(`/escursione/${encodeURIComponent(id)}`)}
