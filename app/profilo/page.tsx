...
import {
  ...
  Crosshair, AlertTriangle, Navigation as NavigationIcon,
} from 'lucide-react'
...
// ── Navigation history / privacy ──────────────────────────────────────────

function NavigationHistorySection() {
  ...
  return (
    <div className="min-h-screen bg-stone-50">
      ...
      <div className="max-w-lg mx-auto px-4 py-10 space-y-4">
        ...
        {/* Navigation history / privacy */}
        <div className="pt-2">
          <p className="text-xs font-semibold uppercase tracking-wider text-stone-400 mb-3">Privacy</p>
