  ...
  return (
    <div className="max-w-[900px] mx-auto px-4 pt-6 pb-12">
      <div className="flex items-center justify-between mb-3">
        <Link href={percorsoPath} className="text-[13px] text-forest-600 font-medium hover:text-forest-700 inline-flex items-center gap-1">
          <ArrowLeft className="w-3.5 h-3.5" /> Torna al Percorso
        </Link>
      </div>
